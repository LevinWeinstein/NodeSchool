...
// To perform a filesystem operation in node.js, you need the
// fs module from the Node core library. To load this kind of module, 
// or any other "global" module, use the following incantation:
var fs = require('fs');
// Now you have the full fs module available in a variable named fd.
//
...
//method you'll end up with an array that has one more element than the number
//of newlines.
//
buffer = fs.readFileSync(process.argv[2]);
string = buffer.toString();

// I didn't like the idea of the split method beign dependent on
